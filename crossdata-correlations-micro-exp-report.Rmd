...
write.csv(cors.df, "results/crossdata-micro-exp-correlations.csv", 
  row.names = FALSE)
```
...
cors.df <- read.csv("results/crossdata-micro-exp-correlations.csv",
...
Inspecting individual scatter-plots for some of the most correlated microRNA/mRNA pairs revealed that many of the positive correlations in cerebellum are being driven by a small number of outliers, particularly individuals 827 and 1037.
