...
print_xtable(subset(t.results, id == "cg15915418"), col.names = TRUE,
...
save_plot("meth-gender-barplot-cg15915418.pdf", width = 7.5, height = 4, 
  path = fig.dir)
```
...
pdf("figures/meth_gender-diffs_top-probes-dotplot.pdf", width = 10, height = 6)
for(p in top.probes) {
